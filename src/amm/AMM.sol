...
contract AMM is ReentrancyGuard {
    ...
    function removeLiquidity(uint256 lpAmount, uint256 amountAMin, uint256 amountBMin, address to, uint256 deadline)
        external
        nonReentrant
        ...
        returns (uint256 amountOut)
    {
        ...
        _updateReserves(
            isAtoB ? reserveA + amountIn : reserveA - amountOut, isAtoB ? reserveB - amountOut : reserveB + amountIn
        );
    ...
    function _optimalAmounts(uint256 amountADesired, uint256 amountBDesired, uint256 amountAMin, uint256 amountBMin)
        internal
        view
        returns (uint256 amountA, uint256 amountB)
    {
