...
/// @title ProtocolToken
/// @notice ERC-20 governance / utility token for the DeFi Super-App protocol.
///
/// @dev    Features:
///         - ERC-20Votes: on-chain delegation and historical vote checkpoints (for governance).
///         - ERC-20Permit: gasless approvals via EIP-2612 signatures.
///         - Hard cap of 100 M tokens enforced at mint time.
///         - AccessControl with MINTER_ROLE; initial supply can be minted by the admin.
///         - Holders can self-burn their own tokens.
contract ProtocolToken is ERC20, ERC20Permit, ERC20Votes, AccessControl {
    // ─── Roles ───────────────────────────────────────────────────────────────
    ...
    constructor(address admin) ERC20("Protocol Token", "PROTO") ERC20Permit("Protocol Token") {
